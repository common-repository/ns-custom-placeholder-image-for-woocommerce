...
<div class="verynsbigboxcontainer">
	<div class="postbox nsproversionfbpx4wp">
        <h3 class="titprofbpx4wp"><?php echo $ns_full_name; ?></h3>
			...
			<!-- <iframe src="https://www.youtube.com/watch?v=HWIdftO74KY&feature=youtu.be" width="100%" height="250px;" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> -->
			<iframe width="100%" height="250" src="https://www.youtube.com/embed/1uNruLmAVZ0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
	        </div>
