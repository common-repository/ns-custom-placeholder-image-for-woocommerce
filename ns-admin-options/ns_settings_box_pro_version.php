...
<div class="nsbigbox<?php echo $ns_style; ?>">
	...
	<div class="contentnsbigbox">
		<p>	<?php _e('ALL FREE VERSION FEATURES and', $ns_text_domain); ?>:<br/><br/> <?php _e('- Choose a placeholder per categories<br/>
			- Choose a placeholder per tags<br/>', $ns_text_domain); ?></p>
